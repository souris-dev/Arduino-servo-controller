...
namespace Arduino_Servo_Cont.v2
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            this.toolTip1.SetToolTip(this.portBox, "This selects the COM port with which your Arduino is\r\nactually connected to. Use " +
        "this with caution and double-\r\ncheck; using a wrong serial port may cause malfun" +
        ...
        {
            // Change the values in the masked text boxes to the
            // values stored in the settings file
            maskedTextBox1.Text = settings.S1;
            maskedTextBox2.Text = settings.S2;
            maskedTextBox3.Text = settings.S3;
            maskedTextBox4.Text = settings.S4;
            maskedTextBox5.Text = settings.S5;
            maskedTextBox6.Text = settings.S6;
            maskedTextBox7.Text = settings.S7;
            maskedTextBox8.Text = settings.S8;
            maskedTextBox9.Text = settings.S9;
            maskedTextBox10.Text = settings.S10;

            // Set the trackbar values to the values in the 
            // masked text boxes
            trackBar1.Value = int.Parse(maskedTextBox1.Text);
            trackBar2.Value = int.Parse(maskedTextBox2.Text);
            trackBar3.Value = int.Parse(maskedTextBox3.Text);
        ...
        {
            // Store the values into the settings file
            settings.S1 = maskedTextBox1.Text;
            settings.S2 = maskedTextBox2.Text;
            settings.S3 = maskedTextBox3.Text;
            settings.S4 = maskedTextBox4.Text;
            settings.S5 = maskedTextBox5.Text;
            settings.S6 = maskedTextBox6.Text; 
            settings.S7 = maskedTextBox7.Text;
